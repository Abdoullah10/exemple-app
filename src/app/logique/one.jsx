...
<label for="index" style={{color:"rgba(255, 255, 255, 0.849)"}} className={styles.b}>{clés[props.n-1]}خمن سعر ال</label>
<br/>
<input id="index" type="number" onChange={n} disabled={control} className={styles.b}/>
